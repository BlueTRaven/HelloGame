...
namespace HelloGame.Guis.Widgets
{
    public class WidgetWindowRectangle : WidgetWindow
    {
        ...
        {
            WidgetTextBox x = AddWidget("bounds_x", new WidgetTextBox(new Rectangle(8, 8, 40, 18), Main.assets.GetFont("bfMunro12"), "X", 4, TextAlignment.Left, TextBoxFilter.Numerical)).SetBackgroundColor(Color.White, Color.Gray);
            WidgetTextBox y = AddWidget("bounds_y", new WidgetTextBox(new Rectangle(56, 8, 40, 18), Main.assets.GetFont("bfMunro12"), "Y", 4, TextAlignment.Left, TextBoxFilter.Numerical)).SetBackgroundColor(Color.White, Color.Gray);
            WidgetTextBox width = AddWidget("bounds_width", new WidgetTextBox(new Rectangle(104, 8, 40, 18), Main.assets.GetFont("bfMunro12"), "Width", 4, TextAlignment.Left, TextBoxFilter.Numerical)).SetBackgroundColor(Color.White, Color.Gray);
            WidgetTextBox height = AddWidget("bounds_height", new WidgetTextBox(new Rectangle(152, 8, 40, 18), Main.assets.GetFont("bfMunro12"), "Height", 4, TextAlignment.Left, TextBoxFilter.Numerical)).SetBackgroundColor(Color.White, Color.Gray);
